...
<div
  ...
  className="relative left-[calc(50%-11rem)] aspect-1155/678 w-144.5 -translate-x-1/2 rotate-30 bg-gradient-to-tr from-[#b0f2b4] to-[#66cc99] opacity-30 sm:left-[calc(50%-30rem)] sm:w-288.75"
/>
        </div>
